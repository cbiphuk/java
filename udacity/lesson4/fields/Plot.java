...
public class Plot
{
    ...
    */
    ...
    public int getNumberOfFields(int radius)
    {
        ...
        int cols = (int)((this.length) / (radius * Math.sqrt(3)));
        int oddRows = this.width / diameter;
        int evenRows = (this.width - radius) / diameter;
        int numberOfFields = ((cols + 1) / 2) * oddRows + (cols / 2) * evenRows;
